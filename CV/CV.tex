...
\begin{document}
	...
	\resumeItemListStart
	\resumeItem{Orchestrated and spearheaded a high-performing penetration testing team, successfully executing targeted exercises on \highlight{80 critical and severe assets} within a single year, fortifying organizational resilience against cyber threats.}
	...
	\resumeItem{Safeguarded external security posture by consistently maintaining an \highlight{'A' rating and $>$90/100 score} on external attack surface management tools, dedication to protecting the organization's assets.}
